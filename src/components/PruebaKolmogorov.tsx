...
import { generadorCuadradoMedio, generadorMixto, pruebaKolmogorov } from "../services/service";


export default function PruebaKolmogorov(props: RouteComponentProps){
    ...
    try {
        ...
        const ret = await pruebaKolmogorov({
            numeros: lista_aux,
    ...
    if (flag === ""){
        ...
        return (
        <GlobalContent>
            <FormTitle>Prueba de Kolmogorov Smirnov</FormTitle>
            <Form>
            <FormInput
                    label="Valor A"
                    name="a"
