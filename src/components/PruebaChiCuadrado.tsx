...
import { generadorCuadradoMedio, generadorMixto, pruebaChiCuadrado, pruebaRachas } from "../services/service";



export default function PruebaChiCuadrado(props: RouteComponentProps){
    ...
    try {
        ...
        const ret = await pruebaChiCuadrado({
            numeros: lista_aux,
            k: k,
    ...
    if (flag === ""){
        ...
        return (
        <GlobalContent>
            <FormTitle>Prueba de Chi Cuadrado</FormTitle>
            <Form>
            <FormInput
                    label="Valor A"
                    name="a"
                ...
                <FormInput
                    label="Ingrese la cantidad de intervalos"
                    name="k"
                    errorHandler={errorHandler}
